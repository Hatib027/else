...
@Component({
  selector: 'app-payment-view-upi',
  templateUrl: './payment-view-upi.component.html',
  styleUrls: ['./payment-view-upi.component.css']
})

export class PaymentViewUpiComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.paymentService.getByUpiId(this.id).subscribe((data: any) => {
  ...
  public Reject() {
    ...
    this.paymentService.actionDepositRequestUpi(this.idData).subscribe(
      (data) => {
